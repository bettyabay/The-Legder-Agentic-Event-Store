...
async def _main() -> None:
    parser = argparse.ArgumentParser(description="Run Week-5 ComplianceAgent for one application.")
    parser.add_argument("--application-id", required=True, help="Application ID, e.g. APEX-0019")
    parser.add_argument("--agent-id", default="compliance-agent-1")
    ...
    try:
        ...
        print(f"OK: compliance agent completed for {args.application_id}")
    finally:
        await pool.close()
